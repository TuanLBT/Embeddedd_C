...
void init_EPWM(void){
	...
	PCC->PCCn[PCC_FTM0_INDEX] 	|=	PCC_PCCn_PCS(1)	|	PCC_PCCn_CGC_MASK; //choose SPLLDIV1_CLK, enable clock
	...
	FTM0->CONTROLS[1].CnV = FTM_CnV_VAL(500); // 50%
	
	FTM0->CNT = 0; //reset counter
	
	FTM0->DEADTIME = FTM_DEADTIME_DTPS(3) | FTM_DEADTIME_DTVAL(7);
	
	FTM0->SC	|= FTM_SC_CLKS(3)| FTM_SC_PS(3) | FTM_SC_PWMEN1_MASK; //choose SOSCDIV1 , prescale: 8 	8MHz : 128 = 1MHz, CHOSE PWM CHANNEL 1
