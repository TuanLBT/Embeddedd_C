...
#open Serial port
bluetooh = serial.Serial("/dev/ttyUSB0",9600) #open port for bluetooh
ser = serial.Serial("/dev/ttyAMA0",115200) #open port send data to stm32
ser1 = serial.Serial("/dev/ttyUSB1",115200) #open port send data to stm32
...
def main_process():
	...
	rospy.Subscriber("cmd_vel", Twist, stm32_vel_values, queue_size=20)
