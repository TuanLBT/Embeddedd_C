...
if("TRUE" STREQUAL "TRUE")
  set(rviz_SOURCE_PREFIX /home/pi/do_an_ws/src/rviz)
  set(rviz_DEVEL_PREFIX /home/pi/do_an_ws/devel/.private/rviz)
  set(rviz_INSTALL_PREFIX "")
  set(rviz_PREFIX ${rviz_DEVEL_PREFIX})
else()
  set(rviz_SOURCE_PREFIX "")
  set(rviz_DEVEL_PREFIX "")
  set(rviz_INSTALL_PREFIX /home/pi/do_an_ws/install)
...
if(NOT "/home/pi/do_an_ws/devel/.private/rviz/include;/home/pi/do_an_ws/src/rviz/src;/usr/include/eigen3;/usr/include/OGRE/Overlay;/usr/include/OGRE;/usr/include " STREQUAL " ")
  set(rviz_INCLUDE_DIRS "")
  set(_include_dirs "/home/pi/do_an_ws/devel/.private/rviz/include;/home/pi/do_an_ws/src/rviz/src;/usr/include/eigen3;/usr/include/OGRE/Overlay;/usr/include/OGRE;/usr/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rviz' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/do_an_ws/src/rviz/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pi/do_an_ws/devel/.private/rviz/lib;/home/pi/do_an_ws/devel/lib;/home/pi/catkin_ws/devel/lib;/home/pi/ros_catkin_ws/devel_isolated/roswtf/lib;/opt/ros/noetic/lib)
