...
if("TRUE" STREQUAL "TRUE")
  set(mpu6050_SOURCE_PREFIX /home/pi/do_an_ws/src/pigeon_imu_driver/mpu6050)
  set(mpu6050_DEVEL_PREFIX /home/pi/do_an_ws/devel/.private/mpu6050)
  set(mpu6050_INSTALL_PREFIX "")
  set(mpu6050_PREFIX ${mpu6050_DEVEL_PREFIX})
else()
  set(mpu6050_SOURCE_PREFIX "")
  set(mpu6050_DEVEL_PREFIX "")
  set(mpu6050_INSTALL_PREFIX /home/pi/do_an_ws/install)
...
if(NOT "/home/pi/do_an_ws/devel/.private/mpu6050/include;/home/pi/do_an_ws/src/pigeon_imu_driver/mpu6050/include " STREQUAL " ")
  set(mpu6050_INCLUDE_DIRS "")
  set(_include_dirs "/home/pi/do_an_ws/devel/.private/mpu6050/include;/home/pi/do_an_ws/src/pigeon_imu_driver/mpu6050/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mpu6050' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/do_an_ws/src/pigeon_imu_driver/mpu6050/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pi/do_an_ws/devel/.private/mpu6050/lib;/home/pi/do_an_ws/devel/lib;/home/pi/catkin_ws/devel/lib;/home/pi/ros_catkin_ws/devel_isolated/roswtf/lib;/opt/ros/noetic/lib)
